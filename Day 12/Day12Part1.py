inputfile = "C:\\Users\\Lantis\\Documents\\GitHub\\Advent-of-Code-2022\\Day 12\\fullinput.txt"
...
while walking:
    ...
    for item in poslist:
        ...
        if (item[0] != 0) and (grid[item[0]-1][item[1]] <= (grid[item[0]][item[1]]+1)):
            ...
            if (target not in destinations) and (target not in visited):
